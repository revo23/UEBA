...
Explanation Engine
Each anomaly gets ranked and annotated with its top contributing features as z-scores relative to the population, with human-readable descriptions (e.g., "impossible travel detected", "many new devices appeared recently").
